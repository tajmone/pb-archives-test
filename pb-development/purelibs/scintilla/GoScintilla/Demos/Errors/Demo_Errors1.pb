...
;*======================================
;*    
;*  Error lines demo program.
;/////////////////////////////////////////////////////////////////////////////////

;/////////////////////////////////////////////////////////////////////////////////
;*NOTE that errors share the #GOSCI_MARGINNONFOLDINGSYMBOLS margin with bookmark symbols and which has a default width of 0.
...
If OpenWindow(0, 100, 200, 700, 600, "GoScintilla demo!", #PB_Window_SystemMenu | #PB_Window_MinimizeGadget | #PB_Window_ScreenCentered)
  ...
  ;Create a menu to allow the user to add bookmarks etc.
    If CreateMenu(0, WindowID(0))
      MenuTitle("Edit")
      MenuItem(#menu_AddError, "Add error")
      MenuItem(#menu_ClearErrors, "Clear Errors")
    EndIf
      ...
      Case #PB_Event_Menu
        Select EventMenu()
          Case #menu_AddError
            ...
            GOSCI_SetLineError(1, currentLine)
          Case #menu_ClearErrors
            GOSCI_SetState(1, #GOSCI_CLEARALLERRORS)
        EndSelect
    EndSelect
